            ...
            <div class="static-content-wrapper">
               ...
               <div class="page-content">
                  <ol class="breadcrumb">
                     ...
                     <li class="active"><a href="customerlist.php">List Users</a></li>
                  </ol>
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <h2 class="panel-title text-success">List Users</h2>
                        </header>
                     </section>
                  </div>
                                 ...
                                 <div class="panel-body no-padding">
                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                       ...
                                       <tbody>
                                          ...
                                          <tr class="odd gradeX">
                                             <td class="center"><?php echo $b++ ; ?></td>
                                             <td class="center"><?php echo $user->name; ?></td>
                                             <td class="center"><?php echo $user->email;; ?></td>
                                             <td class="center"><?php echo $user->password; ?></td>
                                             <td class="center"><a class="btn btn-xs btn-success btn-raised btn-label" href="edit_user.php?id=<?php //echo $rs['id']; ?>">Edit</a> 
                                                <a class="btn btn-xs btn-danger btn-raised btn-label" onClick="abc(<?php //echo $rs['id']; ?>)" href="#">Delete</a> 
                                             </td>
                                          </tr>
                                          <?php } ?>
                                       </tbody>
